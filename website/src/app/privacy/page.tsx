...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "HitItOff Privacy Policy: how we collect, use, and protect profile data, location, photos, quiz answers, and account information.",
  path: "/privacy",
});
    ...
    <>
      ...
      <article className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        ...
        <ul>
          ...
          <li>Quiz answers used to generate compatibility scores</li>
          <li>Location data when you grant permission, used for nearby discovery</li>
